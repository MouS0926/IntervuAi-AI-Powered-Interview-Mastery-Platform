            ...
            Next
              ...
              <div className="btn-style">
                ...
                className={listening ?'bg-blue-800 text-white px-4 py-2 font-medium rounded-full mr-2 hover:bg-blue-600' : 'bg-blue-500 text-white px-4 py-2 font-medium rounded-full mr-2 hover:bg-blue-600'} >
                  {listening ? <BsSoundwave className='wave-icon wave'/> : <BsFillMicFill/>}
                </button>
...
<br />
              <div className='p-8 rounded-lg shadow-md bg-orange-100'>
           ...
           :
           <p className="text-center text-sky-900 text-xl">Receive feedback here after submitting the answer </p>
